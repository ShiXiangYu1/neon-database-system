...
function displayMockData() {
  ...
  // 直接更新销售统计卡片
  setElementText('total-sales', formatCurrency(salesOverviewData.sales.total));
  setElementText('today-sales', formatCurrency(salesOverviewData.sales.today));
  setElementText('yesterday-sales', formatCurrency(salesOverviewData.sales.yesterday));
  setElementText('week-sales', formatCurrency(salesOverviewData.sales.week));
  
  // 更新订单统计卡片
  setElementText('total-orders', formatNumber(salesOverviewData.orders.total));
  setElementText('today-orders', formatNumber(salesOverviewData.orders.today));
  setElementText('pending-orders', formatNumber(salesOverviewData.orders.pending));
  setElementText('month-orders', formatNumber(salesOverviewData.orders.month));
